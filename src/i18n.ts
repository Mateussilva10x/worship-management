...
const resources = {
  en: {
    translation: {
      ...
      "confirmDeleteSongMessage": "Are you sure you want to delete the song \"{{songTitle}}\"? This action cannot be undone.",
      ...
      "newGroup": "New Group",
      "confirmGroupDelete": "Are you sure you want to delete the group \"{{groupName}}\"? This action cannot be undone.",
  ...
  pt: {
    translation: {
      ...
      "confirmDeleteMessage": "Você tem certeza que deseja excluir esta escala? Esta ação não pode ser desfeita.",
      ...
      "confirmDeleteSongMessage": "Você tem certeza que deseja excluir a música \"{{songTitle}}\"? Esta ação não pode ser desfeita.",
      ...
      "confirmGroupDelete": "Você tem certeza que deseja excluir o grupo \"{{groupName}}\"? Esta ação não pode ser desfeita.",
